...
-- SELECT A1.*, A2.*
-- FROM ACTOR A1, ACTOR A2, MOVACT MA1, MOVACT MA2
-- WHERE A1.ACTOR_ID <> A2.ACTOR_ID AND 
--      A1.ACTOR_ID = MA1.ACTOR_ID AND 
--      A2.ACTOR_ID = MA2.ACTOR_ID AND 
--      MA1.MOVIE_ID = MA2.MOVIE_ID;

-- SELECT A1.*, A2.*
-- FROM ACTOR A1, MOVACT MA1
-- INNER JOIN ACTOR A2, MOVACT MA2
-- ON A1.ACTOR_ID <> A2.ACTOR_ID AND MA1.ACTOR_ID = MA2.;

-- SELECT M.MOVIE_TITLE, G.GENRE_NAME, AVG(R.REVIEW_RATING)
-- FROM MOVIES M, (SELECT M.MOVIE_ID
...
-- 		LIMIT 1) AS mov_id, GENRE G, REVIEW R, MOVGEN MG
-- WHERE
-- 	M.MOVIE_ID = mov_id AND
...
-- 			GROUP BY A.ACTOR_ID
-- 			ORDER BY COUNT(MA1.ACTOR_ID, MA2.ACTOR_ID) DESC
-- 			LIMIT 1) AND
