...
-- USER_ID INTEGER,
-- CONSTRAINT "userid" FOREIGN KEY (USER_ID) REFERENCES RAKEUSER(USER_ID) ON DELETE CASCADE,
...
-- CREATE TABLE MOVREV
-- (MOVIE_ID INTEGER,
-- CONSTRAINT "movieid" FOREIGN KEY (MOVIE_ID) REFERENCES MOVIES(MOVIE_ID) ON DELETE CASCADE,
-- REVIEW_ID INTEGER,
-- CONSTRAINT "reviewid" FOREIGN KEY (REVIEW_ID) REFERENCES REVIEW(REVIEW_ID) ON DELETE CASCADE);
...
-- CONSTRAINT "userid" FOREIGN KEY (USER_ID) REFERENCES RAKEUSER(USER_ID) ON DELETE CASCADE,
-- ACTOR_ID INTEGER,
-- CONSTRAINT "actorid" FOREIGN KEY (ACTOR_ID) REFERENCES ACTOR(ACTOR_ID) ON DELETE CASCADE);
...
-- CONSTRAINT "movieid" FOREIGN KEY (MOVIE_ID) REFERENCES MOVIES(MOVIE_ID) ON DELETE CASCADE,
-- GENRE_ID INTEGER,
-- CONSTRAINT "genreid" FOREIGN KEY (GENRE_ID) REFERENCES GENRE(GENRE_ID) ON DELETE CASCADE);
...
-- CONSTRAINT "movieid" FOREIGN KEY (MOVIE_ID) REFERENCES MOVIES(MOVIE_ID) ON DELETE CASCADE,
-- STUDIO_ID INTEGER,
-- CONSTRAINT "studioid" FOREIGN KEY (STUDIO_ID) REFERENCES STUDIO(STUDIO_ID) ON DELETE CASCADE);

-- CREATE TABLE MOVDIR
-- (MOVIE_ID INTEGER,
-- CONSTRAINT "movieid" FOREIGN KEY (MOVIE_ID) REFERENCES MOVIES(MOVIE_ID) ON DELETE CASCADE,
-- DIR_ID INTEGER,
-- CONSTRAINT "dirid" FOREIGN KEY (DIR_ID) REFERENCES DIRECTOR(DIR_ID) ON DELETE CASCADE);
